...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index">CouchTalks</a>
        </div>
        <div class="collapse navbar-collapse" id="responsive-menu">
            <ul class="nav navbar-nav navbar-right">
                ...
                <sec:authorize access="isAnonymous()">
                    ...
                    <li class="${not empty SPRING_SECURITY_LAST_EXCEPTION.message?"dropdown open":"dropdown"}">
                        <a href="#" class="dropdown-toggle"
                           data-toggle="dropdown" ${not empty SPRING_SECURITY_LAST_EXCEPTION.message?"aria-expanded=\"true\"":""}><b>Sign
                            in</b> <span
                                class="caret"></span></a>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <form:form method="POST" class="form" role="form" action="login"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <form:input path="username" id="inputLogin" name="username"
                                                            type="text"
                ...
                <sec:authorize access="isAuthenticated()">
                    ...
                    <li><img class="media-object img-avatar-header"
                    ...
                    <li class="dropdown">
                        ...
                        <a class="dropdown-toggle" data-toggle="dropdown" userId="${user.id}" id="user">${user.username}<span
                                class="caret"></span></a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#">Settings</a></li>
                                <%--<form><li><a href="/logout?${_csrf.parameterName}=${_csrf.token}">Log off</a></li></form>--%>
                                <%--<input type="submit" value="Sign out" />--%>
                            <form:form action="/logout?${_csrf.parameterName}=${_csrf.token}" method="POST">
                                <li><a onclick="$(this).closest('form').submit()">Sign out</a></li>
                            </form:form>
